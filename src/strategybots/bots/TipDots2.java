...
public class TipDots2 implements Player<DotsAndBoxes>{
	...
	public TipDots2() {
		rand = new Random();
		System.out.println("Tip's Dots and Boxes Bot 2 Loaded");
	}
	...
	public void takeTurn(DotsAndBoxes game, int playerId) {
		...
		Triple result = getBestMove(game, playerId);	
    ...
    private void printStats(int score, int playerId, int moveX, int moveY, int moveSide, int depth, long start) {
        ...
        System.out.println("=======================");
        System.out.println("Tiptaco's DNB Bot 2 Statistics:");
    ...
    @Override
    public String getName() { return "TipTacos's Dots and Boxes 2 Bot"; }
