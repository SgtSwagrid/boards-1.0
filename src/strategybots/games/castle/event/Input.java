package strategybots.games.castle.event;

import static strategybots.games.castle.event.InputEvent.KeyboardEvent.*;
import static strategybots.games.castle.event.InputEvent.MouseEvent.*;
import static strategybots.games.castle.event.InputEvent.MouseEvent.MouseButtonEvent.*;
...
import strategybots.games.castle.event.Timing.GameTickEvent;
