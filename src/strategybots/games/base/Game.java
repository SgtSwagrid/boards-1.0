 ...
 * Manages turn order progression.
 * 
...
public abstract class Game {
    ...
    /** The winner of the game. Will be null until game completion. */
    ...
    /**
     * @return the ID of the player who won, or -1 if the game is in progress.
     */
